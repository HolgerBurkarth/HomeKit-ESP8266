...
$AUT Holger Burkarth
$DAT >>arduino_homekit_server.h<< 08 Okt 2024  09:39:26 - (c) proDAD
*******************************************************************/
#pragma endregion
...
#pragma region homekit_client_step_t
typedef enum
{
...
#pragma region homekit_endpoint_t
typedef enum
{
...
#pragma region pairing_context_t
typedef struct
{
  Srp* srp;
  byte* public_key;
...
#pragma region pair_verify_context_t
typedef struct
{
  byte* secret;
  size_t secret_size;
...
#pragma region homekit_server_t
typedef struct
{
...
#pragma region characteristic_event_t
typedef struct
{
...
#pragma region _client_context_t
struct _client_context_t
{
...
#pragma region characteristic_format_t
typedef enum
{
